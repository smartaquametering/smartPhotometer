...
- by distributing different analysis methods **on multiple meshed AquaMeters**.
...
Connect the smartPhotometers microcontrollers (including their connected sensors) via WiFi to your internal network and orchestrate them by using simple web- or MQTT-based APIs.
