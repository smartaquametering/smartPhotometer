...
|#                      | Sensor                     |smart-IR-Turbidimeter       |smart-Colorimeter                   |
|-----------------------|----------------------------|----------------------------|------------------------------------|
|Case                   |                            |smart-IR-Turbidimeter.stl   |smart-Colorimeter.stl               |
|Case Lid               <td colspan=3>smartPhotometer-Case-Lid.stl||
|Cuevette Holder        |                            |                            |smart-Colorimeter-Cuvette-Holder.stl|
